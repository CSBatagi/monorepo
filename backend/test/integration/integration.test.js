/*
 ...
 Assumptions:
  ...
  - Postgres seeded with some data (at least tables exist) so /stats/incremental returns 200.
 This test will:
   1. Hit /stats/incremental without lastKnownTs => expect updated flag present.
...
async function getStats(params){
  const url = new URL('/stats/incremental', BASE);
...
describe('docker-compose integration: /stats/incremental', () => {
