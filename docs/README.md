...
Use this folder as the canonical context source.

## Agent Onboarding

1. [`../AGENTS.md`](../AGENTS.md)
2. [`development/local-setup.md`](development/local-setup.md)
3. [`development/stats-runtime.md`](development/stats-runtime.md)
4. [`operations/stats-publishing.md`](operations/stats-publishing.md)
5. [`operations/security-secrets.md`](operations/security-secrets.md)
6. [`features/steam-integration.md`](features/steam-integration.md) if relevant
