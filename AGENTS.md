...
4. [`docs/operations/stats-publishing.md`](docs/operations/stats-publishing.md)
5. [`docs/operations/security-secrets.md`](docs/operations/security-secrets.md)
6. [`docs/features/steam-integration.md`](docs/features/steam-integration.md) when touching Steam avatars or profile links.
...
- Production stats publish flow and incident checks live in `docs/operations/stats-publishing.md`.
