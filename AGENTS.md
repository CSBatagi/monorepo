...
- Notification scheduler runs in the **backend** (`backend/notificationScheduler.js`), not in Next.js. firebase-admin in the frontend only loads on-demand for admin API routes.
