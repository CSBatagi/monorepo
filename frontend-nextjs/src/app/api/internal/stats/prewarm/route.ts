...
const DATASET_PAGE_MAP: Record<string, string[]> = {
  ...
  night_avg_periods: ['/gece-ortalama', '/performans-odulleri', '/gecenin-mvpsi', '/batak-allstars', '/token-wars'],
  sonmac_by_date: ['/sonmac', '/mac-sonuclari', '/batak-allstars'],
  sonmac_by_date_periods: ['/sonmac', '/mac-sonuclari', '/batak-allstars', '/token-wars'],
