  ...
  return (
    <div id="page-demolar" className="page-content page-content-container">
      ...
      <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
        Sunucuda kaydedilen maç demoları ve üyelerin başka sunuculardan (xplay.gg vb.) yüklediği demolar. İndirip CS2 içinde veya CS Demo Manager ile izleyebilirsiniz; tamamlanan maçlar otomatik olarak istatistiklere işlenir.
      </p>
      <DemolarClient />
    </div>
  );
