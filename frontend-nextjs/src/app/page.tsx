...
const tiles: { href: string; title: string; desc: string; icon: LucideIcon }[] = [
  ...
  { href: '/token-wars', title: 'Batak Token Wars', desc: 'Token Wars puanlarını yönetin.', icon: Coins },
  { href: '/superliga', title: 'Superliga', desc: 'Puan bazlı tek liste lig sıralaması.', icon: Award },
